...
public class Main_com extends AppCompatActivity {
    ...
    public void find_weather(){
        ...
        String url = "http://api.openweathermap.org/data/2.5/weather?q=moroni&appid=90ebdc57172a838d0fce0abbc044df8e";
