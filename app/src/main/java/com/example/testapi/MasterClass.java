...
public class MasterClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityAsk = getIntent().getStringExtra("city");
        find_weather();
    ...
    public void find_weather(){
        ...
        String url = "http://api.openweathermap.org/data/2.5/weather?q="+cityAsk+"&appid=90ebdc57172a838d0fce0abbc044df8e";
