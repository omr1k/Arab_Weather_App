...
public class Main_ku extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_ku);
    ...
    public void find_weather(){
        ...
        String url = "http://api.openweathermap.org/data/2.5/weather?q=kuwait&appid=90ebdc57172a838d0fce0abbc044df8e";
