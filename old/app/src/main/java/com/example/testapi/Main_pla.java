...
public class Main_pla extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_pla);
    ...
    public void find_weather(){
        ...
        String url = "http://api.openweathermap.org/data/2.5/weather?q=jerusalem&appid=90ebdc57172a838d0fce0abbc044df8e";
